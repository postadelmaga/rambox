Ext.define('Rambox.store.ServicesList', {
	...
	,data: [
		...
		},
		{
			...
			,type: 'messaging'
			,js_unread: 'function removeElement(e){e&&e.remove()}function removeElementById(e,t){var n=document.getElementById(e);n&&t&&(n=n.parentElement),removeElement(n)}function removeElementByClass(e){var t=document.getElementsByClassName(e);t.length>0&&t[0].remove()}function setToolbar(){var e=document.getElementById("logo"),t=e.querySelector("img");t.src="https://www.atlassian.com/assets/img/icons/imkt/imkt-navbar__charlie-logo.svg",t.style.height="100px",removeElementByClass("aui-header-before"),removeElementById("home_link",!0),removeElementById("browse_link"),removeElementById("greenhopper_menu"),removeElementById("create-menu"),removeElementById("jira-header-feedback-link"),removeElementById("system-help-menu")}function getBigImage(e){var t=document.createElement("a");return t.href=e,t.protocol+"//"+t.host+t.pathname}function setIssuePage(){if(-1!==document.baseURI.search("/browse")){(img=document.querySelector("#assignee-val img"))&&(document.querySelector(".issue-header-content .aui-page-header-image .aui-avatar-inner img").src=getBigImage(img.src)),removeElementById("viewissue-devstatus-panel"),removeElementById("greenhopper-agile-issue-web-panel_heading"),removeElementByClass("aui-sidebar-wrapper"),removeElementByClass("toolbar-split toolbar-split-right");var e=document.getElementsByClassName("aui-page-panel");e.length>0&&(e[0].style.paddingLeft="0px")}}function setPage(){setToolbar(),setIssuePage(),removeElementByClass("dashboard-tabs"),setTimeout(setBodyWidth,250)}function setBodyWidth(){document.body.style.minWidth="400px"}function setFinal(){}document.onload=setPage();'
		},
		{
			 id: 'messengerpages'
